...
# 等价裸命令
go test -tags netgo,sqlite_fts5 ./core/jukebox
...
```bash
cd ui
npm run test        # Vitest 单跑（88 文件 / 774 用例）
npx vitest run src/audioplayer/VolumeControl.test.jsx   # 只跑一个文件
                  # 注意：本版本 vitest 没有 --reporter=basic，别加
