...
func (api *Router) routes() http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			// Alias with a file extension in the path, for renderers that
			// reject extension-less URLs (e.g. Xiaoai speakers via text directives)
			hr(r, "stream/{file}", api.StreamAlias)
